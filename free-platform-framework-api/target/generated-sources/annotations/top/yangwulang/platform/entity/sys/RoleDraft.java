...
public interface RoleDraft extends Role, BaseEntityDraft {
    ...
    class Producer {
        ...
        public static final ImmutableType TYPE = ImmutableType
            ...
            .id(7, "roleCode", String.class)
            .key(8, "roleName", String.class)
            .add(9, "roleType", ImmutablePropCategory.SCALAR, String.class, true)
            .add(10, "roleSort", ImmutablePropCategory.SCALAR, BigDecimal.class, true)
            .add(11, "sys", ImmutablePropCategory.SCALAR, boolean.class, true)
            .add(12, "userType", ImmutablePropCategory.SCALAR, String.class, true)
            .add(13, "dataScope", ImmutablePropCategory.SCALAR, String.class, true)
            .add(14, "bizScope", ImmutablePropCategory.SCALAR, String.class, true)
            .add(15, "corpCode", ImmutablePropCategory.SCALAR, String.class, true)
            .add(16, "corpName", ImmutablePropCategory.SCALAR, String.class, true)
            .add(17, "menus", ManyToMany.class, Menu.class, false)
            .build();
        ...
        public abstract static class Implementor implements Role, ImmutableSpi {
            ...
            public Object __get(int prop) {
                switch (prop) {
                    ...
                    case 7: return roleCode();
                    case 8: return roleName();
                    case 9: return roleType();
                    case 10: return roleSort();
                    case 11: return (Boolean)isSys();
                    case 12: return userType();
                    case 13: return dataScope();
                    case 14: return bizScope();
                    case 15: return corpCode();
                    case 16: return corpName();
                    case 17: return menus();
        ...
        private static class Impl extends Implementor implements Cloneable {
            ...
            public boolean __isLoaded(int prop) {
                switch (prop) {
                    ...
                    case 7: return roleCode != null;
                    case 8: return roleName != null;
                    case 9: return roleTypeLoaded;
                    case 10: return roleSortLoaded;
                    case 11: return sysLoaded;
                    case 12: return userTypeLoaded;
                    case 13: return dataScopeLoaded;
                    case 14: return bizScopeLoaded;
                    case 15: return corpCodeLoaded;
                    case 16: return corpNameLoaded;
                    case 17: return menus != null;
                    default: throw new IllegalArgumentException("Illegal property id: \"" + prop + "\"");
                }
            }
            ...
            private int __shallowHashCode() {
                ...
                if (menus != null) {
                    hash = 31 * hash + System.identityHashCode(menus);
                }
                return hash;
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (__roleCodeLoaded != other.__isLoaded(7)) {
                    return false;
                }
                if (__roleCodeLoaded) {
                    // If entity-id is loaded, return directly
                ...
                if (__roleNameLoaded != other.__isLoaded(8)) {
                    return false;
                }
                ...
                if (__roleTypeLoaded != other.__isLoaded(9)) {
                    return false;
                }
                ...
                if (__roleSortLoaded != other.__isLoaded(10)) {
                    return false;
                }
                ...
                if (__sysLoaded != other.__isLoaded(11)) {
                    return false;
                }
                ...
                if (__userTypeLoaded != other.__isLoaded(12)) {
                    return false;
                }
                ...
                if (__dataScopeLoaded != other.__isLoaded(13)) {
                    return false;
                }
                ...
                if (__bizScopeLoaded != other.__isLoaded(14)) {
                    return false;
                }
                ...
                boolean __menusLoaded = menus != null;
                if (__menusLoaded != other.__isLoaded(17)) {
                    return false;
                }
                if (__menusLoaded && !Objects.equals(menus, other.menus())) {
                    return false;
                }
                return true;
            }
            ...
            private boolean __shallowEquals(Object obj) {
                ...
                if (__menusLoaded && menus != other.menus()) {
                    return false;
                }
                return true;
            }
        ...
        private static class DraftImpl extends Implementor implements DraftSpi, RoleDraft {
            ...
            public List<MenuDraft> menus(boolean autoCreate) {
                if (autoCreate && (!__isLoaded(17) || menus() == null)) {
            ...
            public RoleDraft setMenus(List<Menu> menus) {
                ...
                Impl __tmpModified = __modified();
                __tmpModified.menus = NonSharedList.of(__tmpModified.menus, menus);
                return this;
            }
            ...
            public void __set(int prop, Object value) {
                switch (prop) {
                    ...
                    case 7: setRoleCode((String)value);break;
                    case 8: setRoleName((String)value);break;
                    case 9: setRoleType((String)value);break;
                    case 10: setRoleSort((BigDecimal)value);break;
                    case 11: 
                            if (value == null) throw new IllegalArgumentException("'sys' cannot be null");
                            setSys((Boolean)value);
                            break;
                    case 12: setUserType((String)value);break;
                    case 13: setDataScope((String)value);break;
                    case 14: setBizScope((String)value);break;
            ...
            public void __unload(int prop) {
                switch (prop) {
                    ...
                    case 7: __modified().roleCode = null;break;
                    case 8: __modified().roleName = null;break;
                    case 9: __modified().roleTypeLoaded = false;break;
                    case 10: __modified().roleSortLoaded = false;break;
                    case 11: __modified().sysLoaded = false;break;
                    case 12: __modified().userTypeLoaded = false;break;
                    case 13: __modified().dataScopeLoaded = false;break;
                    case 14: __modified().bizScopeLoaded = false;break;
            ...
            public Object __resolve() {
                ...
                try {
                    ...
                    if (__tmpModified == null) {
                        ...
                        __tmpModified.menus = NonSharedList.of(__tmpModified.menus, __ctx.resolveList(__tmpModified.menus));
                    }
